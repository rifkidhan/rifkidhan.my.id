...
export default function BlogSection({ title, image, content }: Props) {
	...
	return (
		<div ref={ref} className="flex flex-col min-h-screen gap-10 md:flex-row">
			...
			<motion.div className="overflow-hidden md:basis-5/12 origin-center">
				<motion.div
					style={{ scale: spring }}
					className="relative block w-full h-4/5"
				>
					<Image
						src={`${imageUrl}/${image}`}
						layout="fill"
